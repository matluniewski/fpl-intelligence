...
This repository currently contains the production application foundation and a framework-independent domain package for normalized football and user-confirmed TeamState contracts. Product capabilities are delivered separately through approved Linear issues.
